module cnn_top (clk,
 ...
 sky130_fd_sc_hd__dfxtp_2 _3201_ (.CLK(clk),
    .D(_0315_),
    .Q(done_r));
 sky130_fd_sc_hd__conb_1 _3202_ (.LO(s_bresp[0]));
 sky130_fd_sc_hd__conb_1 _3203_ (.LO(s_bresp[1]));
 sky130_fd_sc_hd__conb_1 _3204_ (.LO(s_rresp[0]));
 sky130_fd_sc_hd__conb_1 _3205_ (.LO(s_rresp[1]));
endmodule
