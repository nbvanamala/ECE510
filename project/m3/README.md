...
- `sim/cosim_waveform.png` — annotated waveform showing three regions: (1) AXI weight writes, (2) pixel tap streaming, (3) AXI DONE poll and result reads
...
- `synthesis_notes.md` — narrative 728 words: what synthesized, glue logic issues, timing, scope status
...
**Environment variable required:** PDK_ROOT must point to sky130A PDK installation
**Note:** Yosys front-end synthesis completed. Full OpenLane 2 PnR deferred to M4.
